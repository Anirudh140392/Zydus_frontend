 ...
 * All APIs used throughout the zydus Frontend Application
...
export const KEYWORD_APIS = {
  ...
  TOGGLE_KEYWORD_STATE: {
    url: "/zydus/toggle_keyword_or_target_state",
    method: "PUT",
...
export const NEGATIVE_KEYWORD_APIS = {
  ...
  GET_SUGGESTED_NEGATIVE_KEYWORDS: {
    url: "/zydus/suggested-negative-keyword",
    method: "GET",
  ...
  ADD_NEGATIVE_KEYWORD: {
    url: "/zydus/add-negative-keyword",
    method: "POST",
  ...
  DELETE_NEGATIVE_KEYWORD: {
    url: "/zydus/delete_negative_keyword",
    method: "DELETE",
