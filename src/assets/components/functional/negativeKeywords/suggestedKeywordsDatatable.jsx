...
const SuggestedKeywordsDatatable = () => {
    ...
    const getKeywordsData = async () => {
        ...
        try {
            const url = `https://react-api-script.onrender.com/zydus/negative_keywords?start_date=${startDate}&end_date=${endDate}&platform=${operator}`;
    ...
    const handleAddNegativeKeyword = async (row) => {
       ...
       try {
    const url = `https://react-api-script.onrender.com/zydus/add-negative-keyword`;
