...
const PlacementsComponent = () => {
    ...
    const selectedBrand = searchParams.get("brand") || "zydus Cosmetics";
    ...
    const getPlacementData = async (forceRefresh = false) => {
        ...
        let url = `https://react-api-script.onrender.com/zydus/placement?start_date=${startDate}&end_date=${endDate}&platform=${operator}${ts}`;
