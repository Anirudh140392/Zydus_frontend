...
const AdGroupsComponent = () => {
    ...
    const fetchAdGroupsData = async () => {
        ...
        try {
            const response = await fetch(
                `https://react-api-script.onrender.com/zydus/adgroups?start_date=${startDate}&end_date=${endDate}&platform=Amazon`,
                {
                    method: "GET",
                    headers: {
    ...
    const handleToggle = async (campaignType, adGroupId, campaignId) => {
        ...
        try {
            ...
            const response = await fetch(`https://react-api-script.onrender.com/zydus/toggle_ad_group?${params.toString()}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
